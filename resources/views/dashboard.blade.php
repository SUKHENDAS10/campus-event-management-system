...
<body>
    ...
    <div class="container my-5">
            ...
            @forelse ($upcomes as $upcome)
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card past-card shadow-sm h-100">
                        ...
                        @endif
                        <div class="card-body">
                            <h5 class="card-title">{{ $upcome->title }}</h5>
                            <p class="card-text">{{ Str::limit($upcome->description, 80) }}</p>
        ...
        {{-- Past Events --}}
        <h2 class="text-center mb-4 text-white bg-dark mt-5">Past Events</h2>
        <div class="row g-4">
